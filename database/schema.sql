...
CREATE TABLE IF NOT EXISTS gd_live_sessions (
    ...
    speaking_time INT NOT NULL DEFAULT 60,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS gd_live_evaluations (
    ...
    weaknesses TEXT,
    improvement_tips TEXT,
    originality_score FLOAT DEFAULT 85,
    critical_thinking_score FLOAT DEFAULT 85,
    topic_understanding_score FLOAT DEFAULT 85,
    voice_clarity_score FLOAT DEFAULT 85,
    body_language_score FLOAT DEFAULT 85,
    eye_contact_score FLOAT DEFAULT 85,
    confidence_score FLOAT DEFAULT 85,
